...
BEGIN_MESSAGE_MAP(CFrameEditor, CWnd)
	...
	ON_WM_KEYDOWN()
	ON_WM_TIMER()
	ON_COMMAND(ID_FRAME_CUT, &ThisClass::OnEditCut)
	ON_COMMAND(ID_FRAME_COPY, &ThisClass::OnEditCopy)
	ON_COMMAND(ID_FRAME_PASTE, &ThisClass::OnEditPaste)
	ON_COMMAND(ID_FRAME_PASTENEWPATTERNS, &ThisClass::OnEditPasteNewPatterns)
	ON_COMMAND(ID_FRAME_DELETE, &ThisClass::OnEditDelete)
	...
	// // //
	ON_COMMAND(ID_FRAME_PASTEOVERWRITE, &ThisClass::OnEditPasteOverwrite)
