...
BEGIN_MESSAGE_MAP(CDetuneDlg, CDialog)
	...
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_OCTAVE, &ThisClass::OnDeltaposSpinOctave)
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_NOTE, &ThisClass::OnDeltaposSpinNote)
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_OFFSET, &ThisClass::OnDeltaposSpinOffset)
	ON_EN_KILLFOCUS(IDC_EDIT_OCTAVE, &ThisClass::OnEnKillfocusEditOctave)
	ON_EN_KILLFOCUS(IDC_EDIT_NOTE, &ThisClass::OnEnKillfocusEditNote)
	ON_EN_KILLFOCUS(IDC_EDIT_OFFSET, &ThisClass::OnEnKillfocusEditOffset)
	ON_BN_CLICKED(IDC_RADIO_NTSC, &ThisClass::OnBnClickedRadioNTSC)
	ON_BN_CLICKED(IDC_RADIO_PAL, &ThisClass::OnBnClickedRadioPAL)
	ON_BN_CLICKED(IDC_RADIO_VRC6, &ThisClass::OnBnClickedRadioVRC6)
	ON_BN_CLICKED(IDC_RADIO_VRC7, &ThisClass::OnBnClickedRadioVRC7)
	ON_BN_CLICKED(IDC_RADIO_FDS, &ThisClass::OnBnClickedRadioFDS)
	ON_BN_CLICKED(IDC_RADIO_N163, &ThisClass::OnBnClickedRadioN163)
	ON_BN_CLICKED(IDC_BUTTON_RESET, &ThisClass::OnBnClickedButtonReset)
	ON_BN_CLICKED(IDC_BUTTON_IMPORT, &ThisClass::OnBnClickedButtonImport)
	ON_BN_CLICKED(IDC_BUTTON_EXPORT, &ThisClass::OnBnClickedButtonExport)
END_MESSAGE_MAP()
