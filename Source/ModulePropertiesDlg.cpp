...
BEGIN_MESSAGE_MAP(CModulePropertiesDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_SONG_ADD, &ThisClass::OnBnClickedSongAdd)
	ON_BN_CLICKED(IDC_SONG_INSERT, OnBnClickedSongInsert)		// // //
	ON_BN_CLICKED(IDC_SONG_REMOVE, &ThisClass::OnBnClickedSongRemove)
	ON_BN_CLICKED(IDC_SONG_UP, &ThisClass::OnBnClickedSongUp)
	ON_BN_CLICKED(IDC_SONG_DOWN, &ThisClass::OnBnClickedSongDown)
	ON_EN_CHANGE(IDC_SONGNAME, &ThisClass::OnEnChangeSongname)
	ON_BN_CLICKED(IDC_SONG_IMPORT, &ThisClass::OnBnClickedSongImport)

	ON_WM_HSCROLL()
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_SONGLIST, &ThisClass::OnLvnItemchangedSonglist)
	ON_BN_CLICKED(IDC_EXPANSION_VRC6, &ThisClass::OnBnClickedExpansionVRC6)
	ON_BN_CLICKED(IDC_EXPANSION_VRC7, &ThisClass::OnBnClickedExpansionVRC7)
	ON_BN_CLICKED(IDC_EXPANSION_FDS, &ThisClass::OnBnClickedExpansionFDS)
	ON_BN_CLICKED(IDC_EXPANSION_MMC5, &ThisClass::OnBnClickedExpansionMMC5)
	ON_BN_CLICKED(IDC_EXPANSION_S5B, &ThisClass::OnBnClickedExpansionS5B)
	ON_BN_CLICKED(IDC_EXPANSION_N163, &ThisClass::OnBnClickedExpansionN163)
