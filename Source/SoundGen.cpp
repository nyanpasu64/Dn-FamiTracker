...
BEGIN_MESSAGE_MAP(CSoundGen, CWinThread)
	ON_THREAD_MESSAGE(WM_USER_SILENT_ALL, &ThisClass::OnSilentAll)
	ON_THREAD_MESSAGE(WM_USER_LOAD_SETTINGS, &ThisClass::OnLoadSettings)
	ON_THREAD_MESSAGE(WM_USER_PLAY, &ThisClass::OnStartPlayer)
	ON_THREAD_MESSAGE(WM_USER_STOP, &ThisClass::OnStopPlayer)
	ON_THREAD_MESSAGE(WM_USER_RESET, &ThisClass::OnResetPlayer)
	ON_THREAD_MESSAGE(WM_USER_START_RENDER, &ThisClass::OnStartRender)
	ON_THREAD_MESSAGE(WM_USER_STOP_RENDER, &ThisClass::OnStopRender)
	ON_THREAD_MESSAGE(WM_USER_PREVIEW_SAMPLE, &ThisClass::OnPreviewSample)
	ON_THREAD_MESSAGE(WM_USER_WRITE_APU, &ThisClass::OnWriteAPU)
	ON_THREAD_MESSAGE(WM_USER_CLOSE_SOUND, &ThisClass::OnCloseSound)
	ON_THREAD_MESSAGE(WM_USER_SET_CHIP, &ThisClass::OnSetChip)
	ON_THREAD_MESSAGE(WM_USER_REMOVE_DOCUMENT, &ThisClass::OnRemoveDocument)
END_MESSAGE_MAP()
