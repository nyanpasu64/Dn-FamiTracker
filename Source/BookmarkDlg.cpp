...
BEGIN_MESSAGE_MAP(CBookmarkDlg, CDialog)
	ON_BN_CLICKED(IDC_BUTTON_BOOKMARK_ADD, &ThisClass::OnBnClickedButtonBookmarkAdd)
	ON_BN_CLICKED(IDC_BUTTON_BOOKMARK_UPDATE, &ThisClass::OnBnClickedButtonBookmarkUpdate)
	ON_BN_CLICKED(IDC_BUTTON_BOOKMARK_REMOVE, &ThisClass::OnBnClickedButtonBookmarkRemove)
	ON_BN_CLICKED(IDC_BUTTON_BOOKMARK_MOVEUP, &ThisClass::OnBnClickedButtonBookmarkMoveup)
	ON_BN_CLICKED(IDC_BUTTON_BOOKMARK_MOVEDOWN, &ThisClass::OnBnClickedButtonBookmarkMovedown)
	ON_BN_CLICKED(IDC_BUTTON_BOOKMARK_CLEARALL, &ThisClass::OnBnClickedButtonBookmarkClearall)
	ON_BN_CLICKED(IDC_BUTTON_BOOKMARK_SORTP, &ThisClass::OnBnClickedButtonBookmarkSortp)
	ON_BN_CLICKED(IDC_BUTTON_BOOKMARK_SORTN, &ThisClass::OnBnClickedButtonBookmarkSortn)
	ON_LBN_SELCHANGE(IDC_LIST_BOOKMARKS, &ThisClass::OnLbnSelchangeListBookmarks)
	ON_LBN_DBLCLK(IDC_LIST_BOOKMARKS, &ThisClass::OnLbnDblclkListBookmarks)
	ON_BN_CLICKED(IDC_CHECK_BOOKMARK_HIGH1, &ThisClass::OnBnClickedCheckBookmarkHigh1)
	ON_BN_CLICKED(IDC_CHECK_BOOKMARK_HIGH2, &ThisClass::OnBnClickedCheckBookmarkHigh2)
	ON_BN_CLICKED(IDC_CHECK_BOOKMARK_PERSIST, &ThisClass::OnBnClickedCheckBookmarkPersist)
END_MESSAGE_MAP()
